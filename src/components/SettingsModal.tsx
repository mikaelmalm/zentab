          ...
          {activeTab === "appearance" ? (
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    onUpdateSettings({ backgroundImageUrl: e.target.value })
                  }
                ...
                <div className="flex bg-zinc-950 rounded border border-zinc-800 p-1">
                  {["small", "medium", "large"].map((size) => (
                    <button
                      key={size}
                      onClick={() =>
                        onUpdateSettings({ timeDisplaySize: size as any })
                      }
              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      onUpdateSettings({ isSearchEnabled: e.target.checked })
                    }
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      onUpdateSettings({ is24HourFormat: e.target.checked })
                    }
                    className="rounded border-zinc-700 bg-zinc-900 text-white"
                  />
                  <label htmlFor="24h" className="text-sm text-zinc-300">
            ...
            <div className="space-y-6">
              {extensions.map((ext) => {
                ...
                const extSettings =
                  settings.extensionSettings?.[ext.id] ?? ext.defaultSettings;
                    ...
                    <div className="bg-zinc-950 border border-zinc-800 rounded-lg p-3">
                      <SettingsComp
                        ...
                        onUpdateSettings={(newVals) => {
                          ...
                          onUpdateSettings({
                            extensionSettings: newExtensionSettings,
                          });
                        }}
                      />
                    </div>
